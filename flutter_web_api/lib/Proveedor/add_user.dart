...
class _AddUserState extends State<AddUser> {
  ...
  void addUser() async {
    if (_formKey.currentState!.saveAndValidate()) {
      ...
      final user = Proveedor(
        idProveedor: 0, // No es necesario establecer manualmente el idProveedor
        nombre: data['nombre'],
      ...
      final uri = Uri.parse(
          "https://10.0.2.2:7267/apiProveedor/CrearProveedor/Create?"
              "nombre=porno&"
              "direccion=${Uri.encodeComponent(user.direccion)}&"
